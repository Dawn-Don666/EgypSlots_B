...
/// 刮刮卡奖励面板
/// </summary>
public class MinigameRewardPanel : BaseUIForms
{
    ...
    private void WatchAdRewardAll()
    {
        ...
        ADManager.Instance.playRewardVideo((b) =>
        {
            if (b)
            {
                PostEventScript.GetInstance().SendEvent("1009", "1", (rewardNumber).ToString());
    ...
    private void Reward10Percent()
    {
        ...
        PostEventScript.GetInstance().SendEvent("1009", "0", ((int)(0.1f * rewardNumber)).ToString());
    ...
    void ClosePanel()
    {
        ...
        CloseUIForm(nameof(MinigameRewardPanel));    //关闭弹窗
        //通知关闭刮刮卡页面
        MessageCenterLogic.GetInstance().Send("Scratch_CloseRewardPanel"); 
    }
}
