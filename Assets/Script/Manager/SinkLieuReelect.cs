...
/// ��Ϸ�е�����
/// </summary>
public class SinkLieuReelect : Christian<SinkLieuReelect>
{
    /// <summary>
    /// ��Bare�����ܱ�־��Ȩ
    /// �ź�̨
    /// </summary>
    public int wildAgeShrill= 5;

    /// <summary>
    /// ����ת������
    /// �ź�̨
    /// </summary>
    public int AirSpeedTopicSpider= 10;

    /// <summary>
    /// ���Spin����
    /// �ź�̨
    /// </summary>
    public int AirFlowDaddy= 30;
    ...
    /// </summary>
    public Dictionary<string, Dictionary<string, int>> PastReactBind= new Dictionary<string, Dictionary<string, int>>
    {
    ...
    /// Win����
    /// </summary>
    public Dictionary<string, int> BogLieu= new Dictionary<string, int>()
    {
        {"EpicWin", 100000 },
        {"SuperMegaWin", 70000 },
        {"MegaWin", 50000 },
    ...
    ///     value:�н����
    /// </summary>
    public Dictionary<string, Dictionary<int, int>> AbsorbBind= new Dictionary<string, Dictionary<int, int>>()
    {
    ...
    /// �ź�̨
    /// </summary>
    public List<SpecialRewardsItem> WeekendSorghumAdopt= new List<SpecialRewardsItem>()
    {
    ...
    /// �ź�̨����Ҫ���������ݷֿ�
    /// </summary>
    public Dictionary<string, FixedSpecialTypeItem> WeekendUserBind= new Dictionary<string, FixedSpecialTypeItem>()
    {
    ...
    /// </summary>
    public int[,] WordFSTrialActress= new int[5, 5]
    {
    ...
    /// <summary>
    /// 5x5FSģʽȨ���ֵ�
    /// key: Bare�ţ�value: Ȩ���ֵ�
    /// Ȩ��, value: Bare���࣬value: Ȩ��ֵ
    /// </summary>
    public Dictionary<string, Dictionary<string, int>> LoftFSReactBind= new Dictionary<string, Dictionary<string, int>>()
    {
    ...
    /// �ź�̨
    /// </summary>
    public Dictionary<string, JackpotDataItem> RespectLieu= new Dictionary<string, JackpotDataItem>()
    {
    ...
    /// �ź�̨
    /// </summary>
    public CompareSizeData ImpetusBackLieu= new CompareSizeData()
    {
    ...
    /// �ź�̨
    /// </summary>
    public OpenBoxData CardButLieu= new OpenBoxData()
    {
        noPrizeWeight = 60,
        diamondWeight = 70,
    ...
    /// �ź�̨
    /// </summary>
    public Match3Data Forum3Lieu= new Match3Data()
    {
    ...
    /// �ź�̨
    /// </summary>
    public ScratchData SilenceLieu= new ScratchData()
    {
        maxPrizeCount = 3,
        probability = 0.5,
    ...
    /// �ź�̨
    /// </summary>
    public LuckyWheelData LimitTopicLieu= new LuckyWheelData()
    {
        grandJackpotWeight = 1,
        majorJackpotWeight = 5,
    ...
    /// �ź�̨
    /// </summary>
    public GoldPigData MealTipLieu= new GoldPigData()
    {
        timeSecond = 7200,
        minDiamond = 4000,
        maxDiamond = 5000,
