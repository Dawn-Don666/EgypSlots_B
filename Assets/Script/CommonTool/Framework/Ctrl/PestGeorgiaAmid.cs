...
{
    public class PestGeorgiaAmid : SettingDB
    {
        public static PestGeorgiaAmid Instance;

        public PestGeorgiaAmid(JsonData setting)
        {
            if (Instance == null)
            {
                Instance = this;
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public T RatGeorgiaMeNo<T>(string id)
        {
