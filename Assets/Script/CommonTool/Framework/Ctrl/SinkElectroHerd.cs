...
{
    public class SinkElectroHerd : SettingDB
    {
        public static SinkElectroHerd Instance;

        public SinkElectroHerd(JsonData setting)
        {
            if (Instance == null)
            {
                Instance = this;
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public T TieElectroOfUp<T>(string id)
        {
