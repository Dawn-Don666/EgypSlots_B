...
public class RelateBarbChemistPoorly : MonoBehaviour
{
[UnityEngine.Serialization.FormerlySerializedAs("needStartRefresh")]    public bool WashSwellEnlarge= true;
    ...
    public void GapChemistPoorly()
    {
        Vector2 cellSize = GetComponent<GridLayoutGroup>().cellSize;
        Vector2 Archaic= GetComponent<GridLayoutGroup>().spacing;
        ...
        float height = spaceTop + spaceBottom + lineCount * cellSize.y + (lineCount - 1) * Archaic.y;
