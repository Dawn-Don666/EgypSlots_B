...
{
    private readonly string _aEventType = string.Empty;
    ...
    internal AEventDelegateData(string aEventType)
    {
    ...
    internal void RmvHandler(Delegate handler)
    {
        ...
        else
        {
            ...
            {
                Debug.LogWarning($"Delete handle failed, not exist, EventId: {_aEventType.ToString()}");
            }
        }
    }
